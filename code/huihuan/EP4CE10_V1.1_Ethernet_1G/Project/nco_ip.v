...
// Retrieval info:  <NETLIST_SECTION active_core="nco_ip_st" >
...
// Retrieval info:      <PRIVATE name = "APR" value="12"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="nco_ip_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="nco_ip_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RCFC" value="nco_ip_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="nco_ip_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="nco_ip_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="nco_ip_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="nco_ip_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="nco_ip_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="nco_ip_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="nco_ip_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="nco_ip_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="nco_ip_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="nco_ip_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="nco_ip_sin_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXC" value="1024"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXF" value="1024"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAWC" value="6"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAWF" value="6"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNWC" value="64"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNWF" value="64"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RDW" value="16"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="1933"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="3072"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "PHI_INC" value="82"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="nco_ip.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="nco_ip_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:     <PORT name = "phi_inc_i" direction="INPUT"  connect_to="phi_inc_i"  default="NODEFVAL"  high_width="11"  low_width="0"  description="" />
...
// =========================================================
// RELATED_FILES: nco_ip_st.v, nco_ip.v;
// IPFS_FILES: nco_ip.vo;
// =========================================================
