...
% file : nco_ip_tb.m
%
% Description : The following Matlab testbench excercises the NCO model nco_ip_model.m
...
[sin_out,cos_out] = nco_ip_model(phi_inc_i,phase_mod_i,freq_mod_i);
fid_s = fopen('fsin_o_nco_ip_matlab.txt','w');
fid_c = fopen('fcos_o_nco_ip_matlab.txt','w');
for i=1:N
  fprintf(fid_s,'%f\n',sin_out(i));
  fprintf(fid_c,'%f\n',cos_out(i));
end
