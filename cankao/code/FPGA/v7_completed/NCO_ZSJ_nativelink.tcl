...
set ipfs_ext "vo"
if {[file exists NCO_ZSJ.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find NCO_ZSJ.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME NCO_ZSJ_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.NCO_ZSJ_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "NCO_ZSJ.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "NCO_ZSJ_tb.${hdl_ext}" -section_id tb -library work
