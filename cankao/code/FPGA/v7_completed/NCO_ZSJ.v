...
// Retrieval info:  <NETLIST_SECTION active_core="NCO_ZSJ_st" >
...
// Retrieval info:      <PRIVATE name = "MPR" value="32"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="NCO_ZSJ_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="NCO_ZSJ_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RCFC" value="NCO_ZSJ_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="NCO_ZSJ_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="NCO_ZSJ_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="NCO_ZSJ_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="NCO_ZSJ_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="NCO_ZSJ_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="NCO_ZSJ_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="NCO_ZSJ_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="NCO_ZSJ_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="NCO_ZSJ_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="NCO_ZSJ_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="NCO_ZSJ_sin_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXC" value="8192"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXF" value="8192"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RDW" value="32"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="6993"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="24576"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "PHI_INC" value="655"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen_enable">
// Retrieval info:      <PRIVATE name = "language" value="Verilog HDL"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen">
// Retrieval info:      <PRIVATE name = "filename" value="NCO_ZSJ.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="NCO_ZSJ_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:     <PORT name = "fsin_o" direction="OUTPUT"  connect_to="fsin_o"  default="NODEFVAL"  high_width="31"  low_width="0"  description="" />
// Retrieval info:     <PORT name = "fcos_o" direction="OUTPUT"  connect_to="fcos_o"  default="NODEFVAL"  high_width="31"  low_width="0"  description="" />
